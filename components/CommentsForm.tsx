  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className='grid grid-col-1 gap-4 mb-4'>
        <textarea 
          ref={commentEl}
          className='p-4 outline-none w-full rounded-lg focus:ring-gray-200 bg-gray-100 rext-gray-700'
          placeholder='Comment'
          name='comment'
          />
      </div>
      <div className='grid grid-col-1 lg:grid-cols-2 gap-4 mb-4'>
        <input
          ...
          className='py-3 px-4 outline-none w-full rounded-lg focus:ring-gray-200 bg-gray-100 rext-gray-700'
          placeholder='Name'
          name='name'
        />
        <input
